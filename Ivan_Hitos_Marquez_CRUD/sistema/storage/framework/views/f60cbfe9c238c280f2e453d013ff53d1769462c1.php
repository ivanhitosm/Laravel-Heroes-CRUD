...
<div class="container">
    ...
    <a href="<?php echo e(url('heroe/create')); ?>" class="btn btn-success">Registrar nuevo heroes</a>
    <br><br>
    ...
    <table class="table table-light">
        ...
        <tbody>
            <?php $__currentLoopData = $heroe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heroes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/heroe/index2.blade.php ENDPATH**/ ?>